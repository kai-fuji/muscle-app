...
export const BodyPartIcon = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 100 260" className={className} {...iconProps}>
    {/* 頭 */}
    <ellipse cx="50" cy="20" rx="11" ry="13" />
    
    {/* 首 */}
    <path d="M44 32 L44 40 L56 40 L56 32" />
    ...
    {/* 胸筋のライン */}
    <path d="M40 52 Q45 55, 50 55 Q55 55, 60 52" />
    ...
    {/* 腰・骨盤 */}
    <path d="M43 105 L44 115 L43 120" />
    <path d="M57 105 L56 115 L57 120" />
    <line x1="44" y1="115" x2="56" y2="115" />
    ...
    {/* 膝 */}
    <ellipse cx="37.5" cy="170" rx="4" ry="6" fill="none" />
    <ellipse cx="62.5" cy="170" rx="4" ry="6" fill="none" />
  </svg>
)
